...
import { Server, Users, Image as ImageIcon, ArrowRight } from "lucide-react";
    ...
    >
      <CardContent className="p-0">
        ...
        <div className="relative">
          {/* Server Image */}
          <div className="relative h-32 bg-gradient-to-br from-indigo-50 to-cyan-50 dark:from-indigo-900 dark:to-cyan-900 overflow-hidden">
            {server.image ? (
              <Image
